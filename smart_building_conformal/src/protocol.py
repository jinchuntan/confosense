...
def compile_to_config(protocol: Protocol, base_config: dict) -> dict:
    ...
    cfg["protocol"] = {
        ...
        "min_train_windows": protocol.partitioning.min_train_windows,
        "min_calibration_windows": protocol.partitioning.min_calibration_windows,
        "min_selection_windows": protocol.partitioning.min_selection_windows,
        "min_calibration_for_level": protocol.interval.min_calibration_for_level,
