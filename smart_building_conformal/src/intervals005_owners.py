...
def method_spec(seed=42,frequency='1h'):
    ...
    return dict(version='matched_intervals005_native_and_causal_v1',seed=seed,
        ...
        alert=dict(rule='immediate_single_sample',k=1,m=1,sampling_frequency=str(pd.Timedelta(frequency)),events='empty; background workload only; no recall/F1/delay/primary feasibility'),
