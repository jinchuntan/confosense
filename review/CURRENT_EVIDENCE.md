...
Evidence: [pilot report](pleia_energy_context005_pilot_20260915/PLEIA_ENERGY_CONTEXT005_PILOT_REPORT.md), [evidence index](pleia_energy_context005_pilot_20260915/EVIDENCE_INDEX.md), [every comparison](../smart_building_conformal/outputs/conditional_context005/pleia_energy_f2_s42_C_v1_analysis/control_rule_channel_summary.csv), [independent validation](../smart_building_conformal/outputs/conditional_context005/first_real_C_v1_coordinator/validation/validation.json), and [next bounded proposal](pleia_energy_context005_pilot_20260915/NEXT_BOUNDED_PROPOSAL.md).
...
[Report](../MATCHED_FOLD2_MULTISEED_REPORT.md); [evidence index](matched_fold2_multiseed_20260914/EVIDENCE_INDEX.md). 125 matched units and broader-method obligations remain; full-study readiness is false.
...
# Current ConfoSense evidence: three-fold BDG2 reduced-grid benchmark

13 September 2026. **Completed:** preserved fold 2 plus newly authorized folds 1 then 0, model seed 42, the same nine candidates and five catalogue seeds, all ten buildings and the one-hour horizon. All study commands exited **0**. **0/3 units selected a primary configuration; 3/3 abstained under the unchanged confidence-bound gates.** The separate inverse objective and fixed diagnostics do not replace primary feasibility. Full-study readiness remains **false**.
...
The checkpoint reader removes duplicate CSV materialization and preserves all old fold-2 values and files with zero fits. A separate independent-audit convolution-rounding defect was repaired without changing production source, thresholds or results; the failed attempt remains published. The benchmark has 9 CQR objects / 27 quantile sub-estimators in total, including the preserved fold-2 fits; controls share fits and persistence adds none. Three original study commands total 3491.322 seconds, with verification costs separate.
