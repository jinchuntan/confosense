...
$batchBackup = 'C:/Users/nigel/ConfoSenseBackups/matched_overnight_20260914'
...
$batchArguments = @('-B',($batchProject + '/scripts/log_pilot_command.py'),'--log',$batchLog,'--','C:/cfs_venv/Scripts/python.exe','-B',($batchRepo + '/review/matched_overnight_20260914/coordinator.py'))
