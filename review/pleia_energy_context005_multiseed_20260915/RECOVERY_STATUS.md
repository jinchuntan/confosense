...
**Status: IN_PROGRESS.** Updated on 16 September 2026 UTC after recovery was launched. The branch is `review/pleia-energy-context005-multiseed-20260915`; `main` remains unchanged.
...
| Seed 44 | The Windows-interrupted run was recovered through its verified checkpoint. The resumed run passed with actual exit 0 after 3,151.076 s; independent validation is active under the sole recorded coordinator worker. No owner or calibrator refit occurred during recovery. |
| Seeds 45–46 | Frozen and ready; no fit has started. |
