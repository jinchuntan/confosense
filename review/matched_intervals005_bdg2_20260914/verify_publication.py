...
def main():
    ...
    samples += [REVIEW.relative_to(ROOT).as_posix()+'/'+name for name in ['EVIDENCE_INDEX.md','EVIDENCE_MANIFEST.csv','PANEL_RESPONSE.md','METHOD_REFERENCES.md','joint_pre_fit_manifest.json','evaluated_commit.json','evaluated_source.zip','SYNTHETIC_ACCEPTANCE.json','VALIDATION_ERRATUM_V4.md','VALIDATION_ERRATUM_V4.json','VALIDATION_RECOVERY_COMMANDS_V4.json','corrected_validation_source_v4.zip','method_specification_resolved_v2.json','enbpi_bounds_diagnosis.csv','delivery_v1/validation.json','VALIDATION_ERRATUM_V5.md','VALIDATION_ERRATUM_V5.json','VALIDATION_RECOVERY_COMMANDS_V5.json','corrected_validation_source_v5.zip']]
