...
def main(out):
    ...
    content+=f'Independent validation maximum observed arithmetic/prediction discrepancy was **{validation["maximum_observed_difference"]:.8g}**; [the per-check CSV](smart_building_conformal/outputs/matched_intervals005/bdg2_pilot_v1_coordinator/validation_v5/reconstruction_checks.csv) records each frozen tolerance. All checks passed; this maximum may arise from large pooled sums rather than prediction reload.\n\n'
