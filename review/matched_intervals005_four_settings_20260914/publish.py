...
def index():
    base='../../smart_building_conformal/outputs/matched_intervals005/four_settings_f2_s42_v2_coordinator/analysis_v2/'
...
def main(label):
    ...
    failed_design=SMART/'protocols/matched_intervals005/pleia_energy_f2_s42_v1'
    if failed_design.exists():paths.append(failed_design)
